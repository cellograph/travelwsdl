...
class YogaServer {
    constructor(options) {
        ...
        this.plugins = [
            (0, core_1.useEngine)({ parse: graphql_1.parse, validate: graphql_1.validate, execute: executor_1.execute, subscribe: executor_1.subscribe, specifiedRules: graphql_1.specifiedRules }),
